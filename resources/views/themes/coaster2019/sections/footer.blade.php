...
<script type="text/javascript" src="{{ PageBuilder::js('jquery.min') }}"></script>
<script type="text/javascript" src="{{ PageBuilder::js('modernizr-2.8.3.min') }}"></script>
<script type="text/javascript" src="{{ PageBuilder::js('popper.min') }}"></script>
<script type="text/javascript" src="{{ PageBuilder::js('plugins') }}"></script>
<script type="text/javascript" src="{{ PageBuilder::js('main') }}"></script>
