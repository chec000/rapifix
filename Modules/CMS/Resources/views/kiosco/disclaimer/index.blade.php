...
<div class="row textbox">
    <div class="col-sm-6">
        <h1> {{trans('admin::kiosco.disclaimer.index.title')}} </h1>
    </div>
    <div class="col-sm-6 text-right">
        @if (Auth::action('legals.create'))
            <a href="{{ route('admin.disclaimer.create') }}" class="btn btn-warning addButton"><i class="fa fa-plus"></i>
                 {{trans('admin::kiosco.disclaimer.index.form-add-button')}}
            </a>
        @endif
    </div>
</div>
