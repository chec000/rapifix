                                            ...
                                            <div class="panel-body">
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        ...
                                                        <div class="form-group">
                                                                <span class="fa fa2x fa-info-circle" style="cursor: pointer;" data-toggle="modal" onclick="openInstructions()">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="input-group">
                                                                <input name="termspdf_{{ $legalsByCountry->country->id }}_{{ $langCountry->id }}"
                                                                       ...
                                                                       @else
                                                                       value="{{ old('termspdf__'.$legalsByCountry->country->id.'_'.$langCountry->id) }}"
                                                                        @endif>
                                                                <span class="input-group-btn">
...
@section('scripts')
    <script type="text/javascript">
        ...
        $( "#legals" ).submit(function( event )
        {
            ...
            if (exit == 1 || exit_tiny == 1 || accepted == 0) {
