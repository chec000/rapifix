                        ...
                        @if (Auth::action('languages.active'))
                            ...
                            @if (Auth::action('languages.delete'))
                                <form id="delete-lang-form-{{ $languague->id }}" action="{{ route('admin.languages.delete', $languague->id) }}", method="POST" style="display: inline">
                                    {{ csrf_field() }}
                                    <a onclick="deleteElement(this)" data-code="{{ $languague->id }}" id="delete-{{ $languague->id }}" class="glyphicon glyphicon-trash itemTooltip" href="#" title="{{ trans('admin::language.delete_lang') }}"></a>
                                </form>
                            @endif
                        @endif
                    </td>
