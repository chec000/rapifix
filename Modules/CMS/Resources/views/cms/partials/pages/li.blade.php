    ...
    <div class='{!! $li_info->type !!}'>
        ...
        <span class="pull-right">
            ...
            @if ($page->group_container && $permissions['group'])
                <a href="{{ route('admin.groups.pages', ['groupId' => $page->group_container]) }}" class="glyphicon glyphicon-list-alt itemTooltip" title="Manage Items"></a>
            @endif
            ...
            @if ($permissions['add'] == true && empty($page->link))
                <a href="{{ route('admin.pages.add', [
                    ...
                    class="glyphicon glyphicon-plus itemTooltip addPage" title="{{ 'Add '.($page->group_container?'Group Page':'Sub Page') }}"></a>
            @endif
            @if ($permissions['edit'] == true)
                <a href="{{ route('admin.pages.edit', ['pageId' => $page->id, 'version' => 0, 'language' => \Request::get('language_id')]) }}" class="glyphicon glyphicon-pencil itemTooltip" title="Edit Page"></a>
            @endif
