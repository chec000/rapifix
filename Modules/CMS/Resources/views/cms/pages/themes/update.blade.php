...
@elseif (isset($saved))
    ...
    <p><a href="{{ route('admin.themes.update', ['themeId' => $theme->id]) }}">&raquo; Return to review page</a></p>
    ...
    <div class="table-responsive">
        <table id="themes-table" class="table table-striped table-bordered">
            ...
            <tr>
                ...
                <th  class="with-th">Name</th>
                <th class="with-th">Label</th>
                <th class="with-th" >Category/Tab</th>
                <th class="with-th">Type</th>            
