...
@if ($can_upload)
    <div class="row">
        ...
        <div class="col-sm-12">
            ...
            {!! Form::open(['url' => route('admin.themes.manage'), 'id' => 'uploadThemeForm', 'enctype' => 'multipart/form-data']) !!}
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $('#exportTheme .btn').click(function () {
                window.location.href = route('admin.themes.export', {themeId: themeIdSelected, withPageData: $(this).data('option')});
            });
