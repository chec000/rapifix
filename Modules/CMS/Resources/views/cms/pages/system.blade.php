    ...
    <div class="tab-content">
        ...
        <div class="tab-pane" id="tab1">
            ...
            <div class="table-responsive">
                <table class="table table-bordered">
                    ...
                    <tr>
                        ...
                        @if ($can_upgrade && $upgrade->required)
                            <td><span class="text-warning">{{ $upgrade->from }} [latest release {{ $upgrade->to }}]</span> <a href="{{ route('admin.system.upgrade') }}">(upgrade)</a></td>
                        @else
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            @endif
                            @if ($can_validate)
                                <a href="{{ route('admin.system.validate-db') }}">(more details)</a>
                            @endif
                        </td>
                    </tr>
                    <tr>
                ...
                @if ($can_upgrade && $upgrade->required)
                    <br /><br />
                    <a class="btn btn-primary" href="{{ route('admin.system.upgrade') }}">Upgrade Coaster CMS</a>
                @endif
            </div>
        </div>
        ...
        @if (Auth::action('coaster.wpimport'))
            <div class="tab-pane" id="tab2">
                <br />
                <a class="btn btn-primary" href="{{ route('admin.wpimport') }}">Wordpress Import (Beta)</a>
            </div>
        @endif
