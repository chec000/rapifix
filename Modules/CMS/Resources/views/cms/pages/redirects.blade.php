...
<div class="table-responsive">
    <table id="redirects" class="table table-striped">
        <thead>
        <tr>
            <th><a href="{!! route('admin.redirects.index').'?order=redirect' !!}">Redirect From</a></th>
            <th><a href="{!! route('admin.redirects.index').'?order=to' !!}">Redirect To</a></th>
            <th><a href="{!! route('admin.redirects.index').'?order=forced' !!}">Forced</a></th>
            @if ($can_edit)
                <th>Remove</th>
            @endif
        </tr>
