...
<div class="row">
    <div class="col-sm-8">
        <h1>{!! trans('admin::menusCMS.title_menus') !!}</h1>
    </div>
    <div class="col-sm-4 v-center" align="right">
        <button id="btnShowStatsMenus" type="button" class="btn btn-primary">
            <i class="fa fa-search"></i> &nbsp {!! trans('admin::menusCMS.records_history') !!}
        </button>
    </div>
</div>

{!! Form::open(['url' => route('admin.menus.index.filters'), 'method' => 'GET']) !!}
    <div class="container-fluid">
        <fieldset class="fieldset_gray">
            <legend class="legend_gray">{!! trans('admin::menusCMS.legend_search') !!}</legend>
            <div class="row">
                <div class=" col-sm-4 {!! FormMessage::getErrorClass('brand_id') !!}">
                    <div class="col-sm-3">
                        {!! Form::label('brand_id', trans('admin::menusCMS.brand').':', ['class' => 'control-label']) !!}
                    </div>
                    <div class="col-sm-9">
                        {!! Form::select('brand_id', $brands, null, ['placeholder' => trans('admin::menusCMS.select_option'),
                ...
                <div class=" col-sm-4 {!! FormMessage::getErrorClass('country_id') !!}">
                    <div class="col-sm-3">
                        {!! Form::label('country_id', trans('admin::menusCMS.country').':', ['class' => 'control-label']) !!}
                    </div>
                    <div class="col-sm-9">
                        {!! Form::select('country_id', $countries, null, ['placeholder' => trans('admin::menusCMS.select_option'),
                ...
                <div class="col-sm-4 {!! FormMessage::getErrorClass('role_copy') !!}">
                    <div class="col-sm-3">
                        {!! Form::label('language_id', trans('admin::menusCMS.language').':', ['class' => 'control-label']) !!}
                    </div>
                    <div class="col-sm-9">
                        {!! Form::select('language_id', $languages, null, ['placeholder' => trans('admin::menusCMS.select_option'),
            ...
            <div class="row">
                <div class=" col-sm-12 " align="right">
                    <button id="search-btn" type="submit" class="btn btn-primary addButton">
                        <i class="fa fa-search"></i> &nbsp; {!! trans('admin::menusCMS.buttons.search') !!}
                    </button>
                </div>
            </div>
        </fieldset>
...
@section('scripts')
    <script type="text/javascript">
        var _SORT_MENU_URL = '{{ url('support/menus/sort') }}';
    </script>
    <script type="text/javascript">
        var selected_menu;
        var selected_item;
