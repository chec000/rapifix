<div class="row">
    ...
    <div class="col-sm-6 text-right">
        @if ($can_edit)
            <a href="{{ route('admin.groups.edit', ['groupId' => $group->id]) }}" class="btn btn-warning addButton">
                <i class="fa fa-pencil"></i> &nbsp; Edit Group Settings</a> &nbsp;
        @endif
        @if ($can_add)
            <a href="{{ route('admin.pages.add', ['pageId' => 0, 'groupId' => $group->id]) }}" class="btn btn-warning addButton">
