                    ...
                    <td>
                        ...
                        @if (Auth::action('cedis.delete'))
                            <form id="delete-cedis-form-{{ $cedis->id }}" action="{{ route('admin.cedis.delete', $cedis) }}", method="POST" style="display: inline">
                                {{ csrf_field() }}
                                <a onclick="document.getElementById('delete-cedis-form-{{ $cedis->id }}').submit();" class="glyphicon glyphicon-remove itemTooltip" href="javascript:{}" title="{{ trans('admin::cedis.general.delete') }}"></a>
                            </form>
                        @endif
                    </td>
                @endif
