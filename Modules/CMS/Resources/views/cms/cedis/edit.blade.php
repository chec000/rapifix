<h1> {{trans('admin::cedis.edit.edit')}}</h1>
<p class="text-right"><a href="{{ route('admin.cedis.index') }}">{{trans('admin::brand.form_add.back_list')}}</a></p>

<form id="form-cedis" method="POST" action="{{ route('admin.cedis.update', $cedis) }}">
    {{ csrf_field() }}
    ...
    <fieldset class="fieldset_gray">
        <div class="row">
            <div class="col-xs-12">
                ...
                <input type="text" name="global_name" class="form-control" required="required" value="{{ old('neighborhood', $cedis->global_name) }}">
            </div>
        </div>
    </fieldset>
            ...
            <div class="col-xs-12 col-sm-12">
                ...
                <select disabled name="country" class="form-control">
                    ...
                    @foreach($countries as $country)
                        <option {{ old('country', $cedis->country_id) == $country->id ? 'selected' : '' }} value="{{ $country->id }}">{{ $country->name }}</option>
                    @endforeach
                </select>
            </div>
        </div>
    ...
    <fieldset class="fieldset_gray">
        ...
        <div class="row">
            ...
            <div class="form-group col-xs-12 col-sm-6">
                ...
                <input type="text" name="address" class="form-control" required="required" value="{{ old('address', $cedis->address) }}">
            </div>

            <!-- Neighborhood -->
            <div class="form-group col-xs-12 col-sm-3">
                <label class="control-label">{{ trans('admin::cedis.add.neighborhood') }}</label>
                <input type="text" name="neighborhood" class="form-control" value="{{ old('neighborhood', $cedis->neighborhood) }}">
            </div>

            <!-- Postal code -->
            <div class="form-group col-xs-12 col-sm-3">
                <label class="control-label">{{ trans('admin::cedis.add.postal_code') }}</label>
                <input type="text" name="postal_code" class="form-control" value="{{ old('postal_code', $cedis->postal_code) }}">
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="form-group col-xs-12 col-sm-3">
                ...
                <input type="text" name="phone_number_01" class="form-control" value="{{ old('phone_number_01', $cedis->phone_number_01) }}">
            </div>

            <!-- Phone number 02 -->
            <div class="form-group col-xs-12 col-sm-3">
                <label class="control-label">{{ trans('admin::cedis.add.phone_number_02') }}</label>
                <input type="text" name="phone_number_02" class="form-control" value="{{ old('phone_number_02', $cedis->phone_number_02) }}">
            </div>

            <!-- Telemarketing -->
            <div class="form-group col-xs-12 col-sm-3">
                <label class="control-label">{{ trans('admin::cedis.add.telemarketing') }}</label>
                <input type="text" name="telemarketing" class="form-control" value="{{ old('telemarketing', $cedis->telemarketing) }}">
            </div>

            <!-- Fax -->
            <div class="form-group col-xs-12 col-sm-3">
                <label class="control-label">{{ trans('admin::cedis.add.fax') }}</label>
                <input type="text" name="fax" class="form-control" value="{{ old('fax', $cedis->fax) }}">
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="form-group col-xs-12 col-sm-6">
                ...
                <input type="email" name="email" class="form-control" value="{{ old('email', $cedis->email) }}">
            </div>

            <!-- Latitude -->
            <div class="form-group col-xs-12 col-sm-3">
                <label class="control-label">{{ trans('admin::cedis.general.latitude') }}</label><span class="required">*</span>
                <input type="text" name="latitude" class="form-control" required="required" value="{{ old('latitude', $cedis->latitude) }}">
            </div>
            ...
            <div class="form-group coñ-xs-12 col-sm-3">
                ...
                <input type="text" name="longitude" class="form-control" required="required" value="{{ old('longitude', $cedis->longitude) }}">
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="form-group col-xs-12 col-sm-4">
                ...
                <div class="input-group">
                    <input readonly id="image_01" class="img_src form-control" name="image_01" type="text" required="required" value="{{ old('image_01', $cedis->image_01) }}">
            ...
            <div class="form-group col-xs-12 col-sm-4">
                ...
                <div class="input-group">
                    <input readonly id="image_02" class="img_src form-control" name="image_02" value="{{ old('image_02', $cedis->image_02) }}" type="text">
                    <span class="input-group-btn">
            ...
            <div class="form-group col-xs-12 col-sm-4">
                ...
                <div class="input-group">
                    <input readonly id="image_03" class="img_src form-control" name="image_03" value="{{ old('image_03', $cedis->image_03) }}" type="text">
                    <span class="input-group-btn">
        ...
        <div class="row">
            ...
            <div class="form-group col-xs-12 col-sm-12">
                ...
                <input type="url" name="banner_link" class="form-control" value="{{ old('banner_link', $cedis->banner_link) }}">
            </div>
        </div>
    </fieldset>
    ...
    <div class="row">
        <div class="col-md-12">
            <div>
                ...
                @foreach ($cedis->country->languages as $i => $language)
                    <div role="panel-group" id="accordion-{{ $language->language->id }}" role="tablist" aria-multiselectable="true">
                        <input data-key="lang" type="hidden" value="{{ $language->language->locale_key }}">

                        <div class="panel panel-default">
                            <div role="tab" class="panel-heading" id="head-{{ $language->language->id }}">
                                <h4 class="panel-title">
                                    <a aria-expanded="true" aria-controls="#control-language-{{ $language->language->id }}" role="button" class="accordion-toggle" data-toggle="collapse" data-parent="#accordion-{{ $language->language->id }}" href="#control-language-{{ $language->language->id }}">{{trans('admin::language.country-language-title') . $language->language->language }}</a>
                                </h4>
                            </div>
                            <div aria-labelledby="head-{{ $language->language->id }}" role="tabpanel" data-parent="#accordion-{{ $language->language->id }}" id="control-language-{{ $language->language->id }}" class="panel-collapse {{ ($language->language->id == Session::get('language') ? 'collapse in' : 'collapse') }}" >
                                <div class="panel-body">
                                    ...
                                    <div class="form-group col-xs-12 col-sm-6">
                                        ...
                                        <!--required="required"-->
                                        <input type="text" name="translate[{{ $language->language->locale_key }}][name]" class="form-control" value="{{ old('translate['.$language->language->locale_key .'][name]', ($cedis->hasTranslation($language->language->locale_key) ? $cedis->translate($language->language->locale_key)->name : '')) }}">
                                    </div>
                                    ...
                                    <div class="form-group col-xs-12 col-sm-6">
                                        ...
                                        <!--required="required"-->
                                        <textarea class="form-control" name="translate[{{ $language->language->locale_key }}][description]" rows="8">{{ old('translate['.$language->language->locale_key .'][description]', ($cedis->hasTranslation($language->language->locale_key) ? $cedis->translate($language->language->locale_key)->description : '')) }}</textarea>
                                    </div>
                                    ...
                                    <div class="form-group col-xs-12 col-sm-6">
                                        ...
                                        <!--required="required"-->
                                        <select data-lang="{{ $language->language->locale_key }}" name="translate[{{ $language->language->locale_key }}][state]" class="form-control select-state">
                                            <option></option>
                                            @foreach ($states['data'] as $state)
                                                <option {{ $cedis->state_key == $state['idState'] ? 'selected' : '' }} value="{{ $state['idState'] }}">{{ $state['stateDescr'] }}</option>
                                            @endforeach
                                        </select>
                                        <input type="hidden" name="translate[{{ $language->language->locale_key }}][state_name]" value="{{ old('translate['.$language->language->locale_key .'][state_name]', ($cedis->hasTranslation($language->language->locale_key) ? $cedis->translate($language->language->locale_key)->state_name : '')) }}">
                                    </div>
                                    ...
                                    <div class="form-group col-xs-12 col-sm-6">
                                        ...
                                        <!--required="required"-->
                                        <select data-lang="{{ $language->language->locale_key }}" name="translate[{{ $language->language->locale_key }}][city]" class="form-control select-city">
                                            <option></option>
                                            @foreach ($cities[$language->language->locale_key]['data'] as $city)
                                                <option {{ $cedis->city_key == $city['idCity'] ? 'selected' : '' }} value="{{ $city['idCity'] }}">{{ $city['cityDescr'] }}</option>
                                            @endforeach
                                        </select>
                                        <input type="hidden" name="translate[{{ $language->language->locale_key }}][city_name]" value="{{ old('translate['.$language->language->locale_key .'][state_name]', ($cedis->hasTranslation($language->language->locale_key) ? $cedis->translate($language->language->locale_key)->city_name : '')) }}">
                                    </div>
                                    ...
                                    <div class="form-group col-xs-12 col-sm-12">
                                        ...
                                        <!--required="required"-->
                                        <input type="text" name="translate[{{ $language->language->locale_key }}][schedule]" class="form-control" value="{{ old('translate['.$language->language->locale_key .'][schedule]', ($cedis->hasTranslation($language->language->locale_key) ? $cedis->translate($language->language->locale_key)->schedule : '')) }}">
                                    </div>
                                    ...
                                    <div class="form-group col-xs-12 col-sm-12">
                                        ...
                                        <div class="input-group">
                                            <input id="banner_{{ $language->language->locale_key }}" class="img_src form-control" name="translate[{{ $language->language->locale_key }}][banner]" value="{{ old('banner', ($cedis->hasTranslation($language->language->locale_key) ? $cedis->translate($language->language->locale_key)->banner_image : '')) }}" type="text">
                                            <span class="input-group-btn">
                                                <a href="{!! URL::to(config('admin.config.public').'/filemanager/dialog.php?type=1&field_id=banner_'.$language->language->locale_key) !!}" class="btn btn-default iframe-btn">{{ trans('admin::countries.add_btn_image') }}</a>
                                            </span>
                                        </div>
                                        <span class="help-block">{!! FormMessage::getErrorMessage('flag') !!}</span>
                                    </div>
