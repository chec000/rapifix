    ...
    function disableRegistrationParameters(registration_parameters_id) {
        $.ajax({
            ...
            success: function (data) {
                let label = $("#status" + registration_parameters_id);
                let iconActive = $("#activeRegistrationParameters" + registration_parameters_id);
                let iconInactive = $("#inactiveRegistrationParameters" + registration_parameters_id);
                if (data.status === 0) {
