...
<div class="row textbox">
    <div class="col-sm-6">
        ...
        <div class="col-sm-6 text-right">
            @if (Auth::action('distributorspool.file'))
            ...
            @endif
            @if (Auth::action('distributorspool.add'))
    ...
    <table class="table table-striped" id="tbl_pool">
        <thead>
            <tr>
                ...
                @if (Auth::action('distributorspool.edit') || Auth::action('distributorspool.delete'))
            ...
            @foreach ($pool as $distributor)
                <tr>
                    ...
                    @if (Auth::action('distributorspool.edit') || Auth::action('distributorspool.delete'))
                        ...
                        @endif
                        @if (Auth::action('distributorspool.delete'))
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $('#upload-file').click(function () {
                ...
                $.ajax({
                    url: '{{ route('admin.pool.upload_file') }}',
                    type: 'POST',
                    data: data,
                    cache: false,
                    dataType: 'json',
