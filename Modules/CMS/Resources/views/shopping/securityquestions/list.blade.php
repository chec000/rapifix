    ...
    function disableSecurityQuestions(security_questions_id) {
        $.ajax({
            ...
            success: function (data) {
                let label = $("#status" + security_questions_id);
                let iconActive = $("#activeSecurityQuestions" + security_questions_id);
                let iconInactive = $("#inactiveSecurityQuestions" + security_questions_id);
                if (data.status === 0) {
