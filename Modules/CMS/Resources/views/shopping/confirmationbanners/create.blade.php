...
<div class="container">
    ...
    <form id="confirmation" method="POST" action="{{ route('admin.confirmationbanners.store') }}">
        {{ csrf_field() }}
        ...
        <div class="form-group">
            <label for="exampleInputEmail1">@lang('admin::shopping.confirmationbanners.add.view.form-country')</label><br />
