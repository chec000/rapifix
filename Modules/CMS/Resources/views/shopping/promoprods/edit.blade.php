        ...
        <div class="form-group">
            ...
            <div class="tab-content">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="promo_key" id="promo_key" class="form-control" required="required" value="{{isset($promo->clv_promo) ? $promo->clv_promo : ''}}"/>
                </div>
        ...
        <form id="prodspromo" method="POST" action="{{ route('admin.promoprods.saveProdPromo') }}">
            ...
            <div id="dynamicDiv">
                ...
                <!--carga de los productos previamente relacionados-->
                        ...
                        @foreach($promo->promoprods as $pp)

                    <div class="added" style="display:block;padding:10px;border:2px solid #692780;margin-bottom:10px;overflow:hidden;" id="holder_' + con +'">'+
                        '<div class="form-group">'+
                                            ...
                                            '<div class="row">'+
                                                '<div class="col-md-12">'+
                                                    ...
                                                    '<div class="form-group">'+
                                                        ...
                                                        '<input name="descprod_' + con +'_{{ $langCountry->locale_key }}" type="text" rel="requerido' + con + '" class="requerido' + con + ' requerido' + con +'_{{ $langCountry->locale_key }} form-control" id="requerido' + con +'_{{ $langCountry->locale_key }}" placeholder="@lang('admin::shopping.promoprods.add.input.descprod')">'+
        ...
        $( document ).ready(function() {
            ...
            $("#formProducPromoButton").click(function (event) {
                ...
                $('.added').each(function (i,elem) {
                    ...
                    $('.requerido' + i).each(function (i, elem) {
