...
<div class="form-group">
        ...
        <div class="col-md-12">
            ...
            <select class="form-control" onchange="this.options[this.selectedIndex].value && (window.location = this.options[this.selectedIndex].value);">
                @foreach($countryUser as $key => $cU)
                    ...
                    <option {{$selected}} value="{{ route('admin.filters.categories.show', ['code' => $filter->code, 'idCountry' => $key, 'idCategory' => 0]) }}">
                        {{ $cU }}
                    </option>
                @endforeach
            </select>
        ...
        <div class="col-md-12">
            ...
            <select class="form-control" onchange="this.options[this.selectedIndex].value && (window.location = this.options[this.selectedIndex].value);">
                @foreach($categoryCountry as $key => $cC)
                    ...
                    <option {{$selected}} value="{{ route('admin.filters.categories.show', ['code' => $filter->code, 'idCountry' => $countryUserSelected, 'idCategory' => $key]) }}">
                        {{ $cC }}
                    </option>
                @endforeach
            </select>
    ...
    <div class="row">
        {!! Form::open( ['route' => 'admin.filters.categories.create']) !!}
        <div class="col-md-10">
                ...
                @foreach($filterProducts as $fP)
                    <tr>
                        ...
                        <td class="text-center">
                            {!! Form::open( ['route' => 'admin.filters.categories.delete', 'id' => 'delete_form']) !!}
