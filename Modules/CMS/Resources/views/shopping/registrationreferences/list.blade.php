    ...
    function disableRegistrationReferences(registration_references_id) {
        $.ajax({
            ...
            success: function (data) {
                let label = $("#status" + registration_references_id);
                let iconActive = $("#activeRegistrationReferences" + registration_references_id);
                let iconInactive = $("#inactiveRegistrationReferences" + registration_references_id);
                if (data.status === 0) {
