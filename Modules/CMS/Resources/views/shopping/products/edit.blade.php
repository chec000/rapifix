                                ...
                                <div role="tabpanel" class="tab-pane " id="produc-country-information-{{ $country['id'] }}">
                                                            ...
                                                            <div class="panel-body">
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            <label class="control-label">
                                                                                {{trans('admin::shopping.products.add.second_general_tab.form-product-ingredients-label')}}
                                                                            </label>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <div class="input-group">
                                                                                <input class="img_src form-control" readonly="true" rel="obligatorio"
                                                                                       type="text" name="product-image-{{ $country['id']}}-{{$language['id'] }}"
                                                                                       id="product-image-{{ $country['id']}}-{{$language['id'] }}">
                                                                                <span class="input-group-btn">
                                                                            <a href="{!! URL::to(config('admin.config.public') . '/filemanager/dialog.php?type=1&field_id=product-image-'.$country['id'].'-'.$language['id'])   !!}" class="btn btn-default iframe-btn">{{ trans('admin::countries.add_btn_image') }}</a>
                                                                        </span>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-6">
                                                                        ...
                                                                        <div class="form-group">
                                                                            <label class="control-label">
                                                                                {{trans('admin::shopping.products.add.second_general_tab.form-product-nutritional-info-label')}}
                                                                            </label>
                                                                            <div class="input-group">
                                                                                <input class="img_src form-control" readonly="true" rel=""
                                                                                       type="text"  name="product-nutritional-info-{{ $country['id']}}-{{$language['id'] }}"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="hidden" name="products_{{ $country['id'] }}" id="products_{{ $country['id'] }}" class="form-control"
                                               value="{{isset($prods['product'][$country['id']]) ? $prods['product'][$country['id']] : ''}}"/>
                                        <div class="row">
                                            <div class="col-xs-12">
                                            ...
                                            <div class="col-xs-10">
                                                <select class="form-control" id="sel_{{ $country['id'] }}">
                                                    <option id="opt_{{ $country['id'] }}" value="">
                                                        @lang('admin::shopping.products.add.input.product')
                                                    </option>
                                                    @foreach(Auth::user()->activeProductsByCountryAndBrand($country['id'], $product['brandId']) as $prod)
                                                        <option id="opt_{{$prod->id}}_{{ $country['id'] }}" value="{{$prod->id}}">{{$prod->product->sku}} - {{$prod->product->global_name}}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                            <div class="col-xs-2">
                                                <button type="button" class="btn btn-default"
                                                        onclick="addProduct({{ $country['id'] }}, {{ Auth::user()->activeProductsByCountryAndBrand($country['id'], $product['brandId']) }})">
                ...
                if ($("#products_"+element.id).length > 0) {
                    ...
                    if(idProd != "")
                    {
                        ...
                        prod.forEach(function(element1) {
                            ...
                            $("#opt_"+element1.id_related+"_"+element.id).hide();
                            $("#dis_"+element1.id_related+"_"+element.id).show();
                        });
                    }
                }
            });
        ...
        function showCountriesByBrand(brand) {
            $.ajax({
                ...
                if (response.status) {
                    ...
                    let json= (@php echo isset($product) ? json_encode($product) : 'undefined' @endphp);
                    if(json!==undefined){
                        $.each(json.countries, function(i, country) {
                            $("#checkCountry_" + country.countryId).prop('checked', country.active != null);
        ...
        $(document).ready(function () {
            ...
            function xyz(){
                ...
                if(json!==undefined){
                    ...
                    $("[name=global-name]").val(json.globalName);

                    if (json.isKit == 1) {
                        $("#is-kit").prop('checked', true);
                    } else {
                        $("#is-kit").prop('checked', false);
                    }
                    ...
                    $.each(json.countries, function(i, country) {
                        ...
                        if (country.active == 1) {
                            $('#active-country-yes-'+country.countryId).prop('checked', true);
                        } else {
                            $('#active-country-no-'+country.countryId).prop('checked', true);
                        }
                        ...
                        $.each(country.detail, function(i,lang){
                            ...
                            $("#product-comments-" + country.countryId + "-" + lang.languageId).val(lang.comments);
            ...
            $("#save-product-information").click(function(){
                                ...
                                if(banderaFinal == 1)
                                {
                                    $.each(countryLangs, function (id, lang) {
                                        ...
                                        if (llenadoInfoCountry != 1) {
                                            ...
                                            $("#product-language-" + countryId + "-" + lang.id + " input, " +
                                                    "#product-language-" + countryId + "-" + lang.id + " textarea").each(function () {
                                        ...
                                        if (hasErrors) {
                                            //bootbox.alert(translations.errorEmptyCountryLanguageItem.replace('$country', countryName).replace('$lang', lang.name));
                                            isValid = false;
                                        } else {
                                            isValid = true;
                                            languages.push({
                ...
                if(banderaFinal != 1 || banderaRelated != 1){
                    isValid = false;
                    if(banderaFinal != 1)
                    {
