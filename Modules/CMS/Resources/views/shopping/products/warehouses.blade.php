...
<div class="form-group">
    {!! Form::open( ['route' => 'admin.products.warehouse.list', 'name' => 'country_form']) !!}
        ...
        {!! Form::hidden('id_country_product', $productCountryId) !!}
    {!! Form::close() !!}
</div>
    <h2>{{ trans('admin::shopping.warehouses.product.label.product') }}: {{ $productName }}</h2>
<div class="form-group">
    {!! Form::open( ['route' => 'admin.products.warehouse.create']) !!}
...
@section('scripts')
    ...
    <script type="text/javascript">
        ...
        $(".actDisabled").click(function () {
            axios.post('{{ route('admin.products.warehouse.off') }}', {
                id: $(this).attr('id')
        ...
        $(".actEnabled").click(function () {
            axios.post('{{ route('admin.products.warehouse.on') }}', {
                id: $(this).attr('id')
            }).then(function (response) {
